...
import {Button, CircularProgress, Grid, IconButton, SvgIcon, Typography} from "@material-ui/core";
...
function FianceSection() {
    ...
    const exportHandler = async () => {
        try {
            ...
            link.href = response.data.data.file_dir
            link.setAttribute('download', 'financial.csv');
